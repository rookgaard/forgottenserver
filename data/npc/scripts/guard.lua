...
function onThink()
    ...
    doTargetCombatHealth(npcId, targetId, COMBAT_HOLYDAMAGE, -config.damageValue.min, -config.damageValue.max, CONST_ME_HOLYDAMAGE)
    npcPosition:sendDistanceEffect(targetPosition, CONST_ANI_HOLY)
